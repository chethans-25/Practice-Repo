...
class axi4_slave_0_config_policy;
  static function void configure(
    input axi4_slave_0_cfg_t cfg,
    ...
    cfg.agent_cfg.ext_clock    = 1;   // clock driven by tb_top
    cfg.agent_cfg.ext_reset    = 1;   // reset driven by tb_top
...
endclass : axi4_slave_0_config_policy
